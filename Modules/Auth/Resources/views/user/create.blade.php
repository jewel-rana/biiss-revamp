                    ...
                    <div class="col-lg-12">
                        <div class="box">
                            <header class="dark">
                                ...
                                <h5>{{ $title ?? 'Add new administer' }}</h5>
                                <!-- .toolbar -->
                                <div class="toolbar">
                            ...
                            <div id="collapse2" class="body">
                                <form class="form-horizontal" id="popup-validation" action="{{ route('user.store') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="email" value="{{ old('email') }}" class="validate[required] form-control" name="email"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="password" value="{{ old('password') }}" class="validate[required] form-control" name="password"
                                                   id="req" placeholder="Password">
                                            @error('password')
                                            <div class="help-block with-errors text-danger"><i
                                                    class="fa fa-times"></i> {{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="password" class="validate[required] form-control" name="password_confirm"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <select name="status" value="{{ old('status') }}" class="validate[required] form-control">
