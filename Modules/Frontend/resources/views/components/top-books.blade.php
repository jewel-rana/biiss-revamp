    ...
    <section class="py-5">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="{{ route('book.featured', 'book') }}" class="view-all">View all</a>
            </div>
            <div class="row g-4">
                <div class="col-12 position-relative">
                    <div class="owl-carousel owl-top-book">
                    ...
                    <!-- Left Arrow -->
                    <button class="slider-arrow-top-book slider-arrow prev d-none d-md-inline" aria-label="Previous">
                    ...
                    <!-- Right Arrow -->
                    <button class="slider-arrow-top-book slider-arrow next d-none d-md-inline" aria-label="Next">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="16" fill="none" stroke="currentColor"
                             stroke-width="2.5" viewBox="0 0 16 16">
