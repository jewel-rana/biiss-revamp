        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-12 position-relative">
                    <div class="owl-carousel owl-top-papers">
                    ...
                    <!-- Left Arrow -->
                    <button class="slider-arrow-top-papers slider-arrow prev d-none d-md-inline"
                            aria-label="Previous">
                    ...
                    <!-- Right Arrow -->
                    <button class="slider-arrow-top-papers slider-arrow next d-none d-md-inline" aria-label="Next">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="16" fill="none" stroke="currentColor"
                             stroke-width="2.5" viewBox="0 0 16 16">
