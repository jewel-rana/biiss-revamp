                  ...
                  <h4><i class="icon-truck icon-large"></i> General Information
                    <span style="min-width: 160px;">
                      ...
                      <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                        <a class="dropdown-item" href="{{ route('library.create', ['type' => 'book']) }}"><i class="fa fa-plus"></i> Book</a>
                        <a class="dropdown-item" href="{{ route('library.create', ['type' => 'journal']) }}"><i class="fa fa-plus"></i> Journal</a>
                        <a class="dropdown-item" href="{{ route('library.create', ['type' => 'document']) }}"><i class="fa fa-plus"></i> Document</a>
                        <a class="dropdown-item" href="{{ route('library.create', ['type' => 'magazine']) }}"><i class="fa fa-plus"></i> Magazine</a>
                        <a class="dropdown-item" href="{{ route('library.create', ['type' => 'seminar']) }}"><i class="fa fa-plus"></i> Seminar</a>
                      </div>
