                ...
                <table class="table table-bordered">
                    ...
                    @foreach ($items as $key => $item)
                        <tr id="parent">
                            ...
                            <td>
                                <a href="{{ route('library.show', $item->item['id'] ) }}" target="_blank" title="{{ $item->item['title'] }}">
                                <?php
                                ...
                                {{-- <p>
                                    <a href="{{ route('library.' . $item->book_id . '/edit/?type=' . $item->item['type']) }}" class="btn btn-success btn-xs mt-4"><i class="fa fa-edit"></i> Edit item</a>
                                </p> --}}
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="btn-group w-100 d-flex" role="group" aria-label="Basic example" style="width:100%;">
                                    <a href="{{ route('library.edit/' . $item->book_id . '?type=' . $item->item['type'] ) }}" class="btn btn-secondary btn-xs"><i class="fa fa-edit"></i> Edit</a>
