                            ...
                            <div class="row">
                                <div class="col-md-12" id="buildyourform">
                                    <div class="row fieldwrapper" id="field1">
                                        ...
                                        <div class="col-md-3 form-group">
                                            <textarea type="text" class="fieldname form-control" name="authorArticle[]"
                                                      placeholder="Articles"></textarea>
                                        </div>
                                        <div class="col-md-2 form-group">
                                            <input type="text" class="fieldname form-control" name="authorPaginate[]"
