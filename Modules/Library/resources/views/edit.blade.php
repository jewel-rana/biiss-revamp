                                            ...
                                            <div class="row fieldwrapper" id="field1">
                                                <div class="col-md-3 form-group">
                                                    <input type="text" class="fieldname form-control"
                                                           name="authorName[]" value="{{ $author->author_name }}"
                                                           placeholder="name">
                                                </div>
                                                <div class="col-md-3 form-group">
                                                    <textarea type="text" class="fieldname form-control"
                                                              name="authorArticle[]"
                                                              placeholder="Articles">{{ $author->author_article }}</textarea>
                                                </div>
                                                <div class="col-md-3 form-group">
                                                    <textarea class="fieldname form-control" name="authorSubject[]"
                                                              placeholder="subject">{{ $author->auth_subject }}</textarea>
                                                </div>
                                                <div class="col-md-2 form-group">
                                                    <input type="text" class="fieldname form-control"
                                                           name="authorPaginate[]" value="{{ $author->pagi }}"
                                                ...
                                                <div class="col-md-1">
                                                    ...
                                                    @else
                                                        <button id="add" data-id="{{ $author->id }}" type="button"
                                                                class="btn btn-danger remove"
                                                                onclick="removeExistingField(this)">X
                                                        </button>
                                                    @endif
                                                </div>
                                            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#selectType').on("change", function (e) {
                e.defaultPrevented;
                var type = $(this).val();
                window.location.href = "{{ route('library.create') }}/?type=" + type;
            });
