                ...
                <form action="" method="POST" id="submitIssueForm">
                    ...
                    <div class="row" id="issueFormParent">
                        <div class="col-md-2">
                            ...
                            @endphp
                            <img src="{{ $coverPhoto }}" id="coverPhoto" class="img-fluid"
                                 alt="{{ $issue->item['title'] }}">
                        ...
                        <div class="col-md-4 basicInfo">
                            ...
                            <table class="table table-condensed">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            id="itemAuthor">{{ date('d/m/Y', strtotime( $issue->start_date ) ) }}</span>
                                    </td>
                                </tr>
                                <tr>
                                    <th>Expired Date</th>
                                    <td>
                                        <span
                                            id="itemPublisher">{{ date('d/m/Y', strtotime( $issue->end_date ) ) }}</span>
                                    </td>
                                </tr>
                                {{-- <tr>
                                    <th>Late Count</th>
