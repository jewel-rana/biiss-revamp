                ...
                <div class="col-md-12">
                    ...
                    <div class="result-container">
                        ...
                        <div class="input-group input-group-lg m-b-20">
                            <input type="text" id="librarySuggest" name="search" class="col-ms-6 form-control input-white mr-2" style="padding: 22px 10px;font-size: 16px;width: 420px;" placeholder="Search by Title, Author, Publisher, Acc No..." />
                        ...
                        <div class="row" id="issueFormParent">
                            <div class="col-md-2">
                                ...
                                <input type="hidden" name="book_id" value="@if( !empty( $item ) ) {{ $item->id }} @endif" id="itemId">
                            </div>
                                ...
                                <table class="table table-condensed">
                                    <tbody>
                                        <tr>
                                            <th>Type</th>
                                            <td>
                                                <span id="itemType">@if( !empty( $item ) ) {{ ucfirst(str_replace('_', ' ', $item->type ) ) }} @endif</span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <th>Title</th>
                                            <td>
                                                <span id="itemTitle">@if( !empty( $item ) ) <a href="/dashboard/library/item/{{ $item->id }}" target="_blank">{{ $item->title }}</a> @endif</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Authors</th>
                                                ...
                                                @if( !empty( $item ) )
                                                    <p class="readMoreParent">
                                                        ...
                                                        @if (strlen(strip_tags($item->bibliography)) > 50)
                                                          ... <button type="button" class="btn btn-info btn-sm readMore">Read More</button>
                                                        @endif
                                                    </p>
                                        ...
                                        <tr>
                                            <th>Publish Date</th>
                                            <td>
                                                <span id="itemPublishDate">@if( !empty( $item ) ) {{ date('d/m/Y', strtotime( $item->accession ) ) }} @endif</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Publication Year</th>
                                            <td>
                                                <span id="itemPublishDate">@if( !empty( $item ) ) {{ $item->publication_year }} @endif</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Call Number</th>
                                            <td>
                                                <span id="itemSelf">@if( !empty( $item ) ) {{ $item->call_number }} @endif</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>ACCNO</th>
                                            <td>
                                                <span id="itemSelf">@if( !empty( $item ) ) {{ $item->acc_number }} @endif</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>ISBN</th>
                                            <td>
                                                <span id="itemSelf">@if( !empty( $item ) ) {{ $item->isbn }} @endif</span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <th>Frequency</th>
                                            <td>
                                                <span id="itemTitle">@if( !empty( $item ) ) {{ $item->friq }} @endif</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Vol</th>
                                            <td>
                                                <span id="itemTitle">@if( !empty( $item ) ) {{ $item->volume_number }} @endif</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>No.</th>
                                            <td>
                                                <span id="itemTitle">@if( !empty( $item ) ) {{ $item->item_number }} @endif</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Month</th>
                                            <td>
                                                <span id="itemTitle">@if( !empty( $item ) ) {{ $item->month_of_publish }} @endif</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Season</th>
                                            <td>
                                                <span id="itemTitle">@if( !empty( $item ) ) {{ $item->season }} @endif</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Year</th>
                                            <td>
                                                <span id="itemTitle">@if( !empty( $item ) ) {{ $item->publication_year }} @endif</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Publisher</th>
                                            <td>
                                                <span id="itemTitle">@if( !empty( $item ) ) {{ $item->publisher }} @endif</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Place</th>
                                            <td>
                                                <span id="itemTitle">@if( !empty( $item ) ) {{ $item->place }} @endif</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>ISSN</th>
                                            <td>
                                                <span id="itemTitle">@if( !empty( $item ) ) {{ $item->issn }} @endif</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Source</th>
                                            <td>
                                                <span id="itemTitle">@if( !empty( $item ) ) {{ $item->source }} @endif</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Remarks</th>
                                            <td>
                                                <span id="itemTitle">@if( !empty( $item ) ) {{ $item->remarks }} @endif</span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span id="itemTitle">@if( !empty( $item ) ) {{ ( strtotime( $item->accession ) > 0 ) ? date('d/m/Y', strtotime( $item->accession ) ) : '' }} @endif</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Vol</th>
                                        ...
                                        <tr>
                                            <th>Acc No</th>
                                            <td>
                                                <span id="itemTitle">@if( !empty( $item ) ) {{ $item->acc_number }} @endif</span>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <th>ISBN</th>
                                            <td>
                                                <span id="itemTitle">@if( !empty( $item ) ) {{ $item->isbn }} @endif</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>ISSN</th>
                                        ...
                                        <tr>
                                            <th>Edate</th>
                                            <td>
                                                <span id="itemTitle">@if( !empty( $item ) ) {{ ( !empty( $item->created_at ) ) ? date('d/m/Y', strtotime( $item->created_at ) ) : '' }} @endif</span>
                                            </td>
                                        </tr>
                            ...
                            <div class="col-md-3 issueInfo">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="copySelect" name="copy_number"  required="true">
                                        ...
                                        @foreach( $item->copies as $cpy )
                                            @if( $cpy->issued == 0)
                                            <option value="{{ $cpy->id }}" @if(isset($_GET['copy']) && $_GET['copy'] == $cpy->copy_number ) selected="selected" @endif>{{ $cpy->copy_number }}</option>
                                            @endif
                                        @endforeach
                                        @else
                                            <option value="">Select Copy</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="issueDate" id="datetimepicker_join" value="{{ date('d-m-Y') }}" class="form-control">
                                </div>
