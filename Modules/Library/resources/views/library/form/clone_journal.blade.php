                    <fieldset class="col-md-4">
                      ...
                      <div class="form-group">
                            ...
                            {{ Form::select('friq', [
                              ...
                              'Series' => 'Series',
                              'others' => 'Others'
                              ], $library->friq, ['class' => 'form-control', 'placeholder' => 'FREQ', 'required' => true]) }}
                      </div>
                      <div class="form-group"> 
                            <label>Volume</label>
                    ...
                    <fieldset class="col-md-4">
                      ...
                      <div class="form-group">
                          <label>Remarks</label>
                          <textarea class="form-control" name="remarks" style="height: 110px;" value="{{ $library->remarks }}" placeholder="Remarks"></textarea>
                      </div>
                      <!-- <div class="form-group"> 
