<fieldset class="col-md-4">
    ...
    <div class="form-group">
        ...
        <input class="form-control datepicker" name="accession" value="{{ $library->accession }}" type="text"
    ...
    <div class="form-group">
        <label>Month</label>
        <input class="form-control" name="month_of_publish" value="{{ $library->month_of_publish }}" type="text"
