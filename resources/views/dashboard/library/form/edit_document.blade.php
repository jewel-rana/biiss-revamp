                    ...
                    <fieldset class="col-md-4">
                          <div class="form-group">
                                <label>ISBN</label>
                                <input type="text" name="isbn" value="{{ $library->isbn }}" class="form-control" placeholder="ISBN">
                          </div>
                          <div class="form-group">
                                <label>ISSN</label>
                                <input type="text" name="issn" value="{{ $library->issn }}" class="form-control" placeholder="ISBN">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                                <label>Source</label>
                                <input type="text" name="source" class="form-control" value="{{ $library->source }}" placeholder="Source">
                          </div>
                          <div class="form-group"> 
                                <label>From</label>
                                <input class="form-control" name="from_where" value="{{ $library->from_where }}" type="text" placeholder="From Where">
                          </div>
                          <div class="form-group"> 
                                <label>Date of Publication</label>
                                <input class="form-control datepicker" name="accession" value="{{ ( !empty( $library->accession ) && strtotime( $library->accession ) > 0 ) ? $library->accession : '' }}" type="text" placeholder="DD-MM-YYYY">
                          </div>
                          <div class="form-group">
                              <label>Remarks</label>
                              <textarea class="form-control" name="remarks" placeholder="Remarks" style="height:110px;">{{ $library->remarks }}</textarea>
                          </div>
                      </fieldset>
                      <fieldset class="col-md-4">
