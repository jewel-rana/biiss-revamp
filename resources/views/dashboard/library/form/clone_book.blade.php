                      ...
                      <div class="form-group">
                        <div class="row">
                          <div class="col-md-6">
                            ...
                            {{ Form::text('authormark', $library->authormark, ['class' => 'form-control', 'placeholder' => 'Authormark', 'required' => true]) }}
                          </div>
                          <div class="col-md-6">
                            ...
                            {{ Form::select('author_type', [
                              ...
                              'Editor' => 'Editor',
                              'Others' => 'Others'
                              ], $library->author_status, ['class' => 'selectpicker form-control', 'id' => 'selectbasic', 'required' => true]) }}
                          </div>
                        </div>
                      </div>
                      <div class="form-group">
                        <div class="row mt-3">
                          <div class="col-md-6">
                            <label>Call No.</label>
                            {{ Form::text('call_number', $library->call_number, ['class' => 'form-control', 'placeholder' => 'CallNO', 'required' => true]) }}
                          </div>
                          <div class="col-md-6">
                            <label>ACCNO</label>
                            {{ Form::text('acc_number', $library->acc_number, ['class' => 'form-control', 'placeholder' => 'ACCNO', 'required' => true]) }}
                          </div>
                        </div>
                      </div>
                      <div class="form-group"> 
                        <div class="row mb-3">
                          <div class="col-md-6">
                            ...
                            {{ Form::date('accession', $library->accession, ['class' => 'form-control datepicker', 'placeholder' => 'DD-MM-YYYY']) }}
                          </div>
                          <div class="col-md-6">
                      ...
                      <div class="form-group">  
                        <div class="row">
                          <div class="col-md-6">
                            ...
                            <input class="form-control" name="copy_number" type="number" placeholder="0" value="{{ $library->copy_number }}" disabled="true">
                          </div>
                          <div class="col-md-6">
                            <label>ISSN</label>
                        ...
                        <div class="input-group">
                          <div class="input-group-prepend">
                            {{ Form::select('currency', [
                              ...
                              'pound' => 'Pound',
                              'rs' => 'Rupee'
                              ], $library->currency, ['class' => 'form-control', 'required' => true]) }}
                          </div>
