                ...
                <table class="table table-bordered" id="myDataTable">
                    ...
                    @foreach( $items as $item )
                        ...
                        <tr>
                            <td>{{ $i++ }}</td>
                            <td>
                                <a href="{{ url('dashboard/library/item/' . $item->item['id'] ) }}" target="_blank">
                                    {{ $item->item['title'] }}
                                </a>
                            </td>
                            ...
                            <td>
                                <a href="{{ url('dashboard/member/profile/' . $item->member['id'] ) }}" target="_blank">
                                    {{ $item->member['name'] }}
                                </a>
                            </td>
                            <td>
                                <a href="{{ url('dashboard/member/profile/' . $item->admin['id'] ) }}" target="_blank">
                                    {{ $item->admin['name'] }}
                                </a>
                            </td>
