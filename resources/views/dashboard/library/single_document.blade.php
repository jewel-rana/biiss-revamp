    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-right">
                @if( strtolower( $item->type ) == 'journal')
                <a class="btn btn-warning" href="{{ url('dashboard/library/clone/' . $item->id . '?type=' . $item->type ) }}"><i class="fa fa-edit"></i> Clone</a>
                @endif
                    ...
                    <table class="table table-striped table-bordered">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ ( !empty( $item->accession ) && strtotime( $item->accession ) > 0 ) ? date('d/m/Y', strtotime( $item->accession ) ) : '' }}</td>
                                <th>ACC Number</th>
                                <td>{{ $item->acc_number }}</td>
                            </tr>
                            <tr>
                                <th>ISBN</th>
                                <td>{{ ( !empty( $item->isbn ) && strtotime( $item->isbn ) > 0 ) ? date('d/m/Y', strtotime( $item->isbn ) ) : '' }}</td>
                                <th>ISSN</th>
                                <td>{{ $item->issn }}</td>
                            </tr>
                            <tr>
