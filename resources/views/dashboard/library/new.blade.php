                  ...
                  <h4><i class="icon-truck icon-large"></i> General Information 
                    <span style="min-width: 160px;">
                      ...
                      <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                        ...
                        <a class="dropdown-item" href="{{ route('dashboard.library.create', ['type' => 'document']) }}"><i class="fa fa-plus"></i> Document</a>
                        <a class="dropdown-item" href="{{ route('dashboard.library.create', ['type' => 'magazine']) }}"><i class="fa fa-plus"></i> Magazine</a>
                        <a class="dropdown-item" href="{{ route('dashboard.library.create', ['type' => 'seminar']) }}"><i class="fa fa-plus"></i> Seminar</a>
                      </div>
  ...
  <script type="text/javascript">
    $(document).ready(function () {
      ...
      $('#selectType').on("change", function(e) {
        ...
        var type = $(this).val();
        console.log();
        window.location = "{{ route('dashboard.library.create') }}/?type=" + type;
      });
