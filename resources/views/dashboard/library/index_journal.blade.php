...
@section('content')
    ...
    <div class="row mb-3" id="customFilters">
      ...
      <div class="col-md-2 columns">
        <input id="volume_number" type="text" class="form-control volume_number" placeholder="VOL" />
      </div>
      <div class="col-md-2 columns">
        <input id="end" type="text" class="form-control item_number" placeholder="NO" />
      </div>
      <div class="col-md-2 columns">
        <input id="end" type="text" class="form-control month" placeholder="Month" />
      </div>
      <div class="col-md-2 columns">
      ...
      <div class="col-md-2 columns mt-3">
        <input id="end" type="text" class="form-control isbn" placeholder="ISSN" />
      </div>
      <div class="col-md-2 columns mt-3">
      ...
      <div class="col-md-2 columns mt-3">
        <input id="end" type="text" class="form-control author" placeholder="Author" />
      </div>
      <div class="col-md-2 columns mt-3">
        <input id="end" type="text" class="form-control article" placeholder="Article" />
      </div>
      <div class="col-md-2 columns mt-3">
        <input id="end" type="text" class="form-control subject" placeholder="Subject" />
      </div>
      <div class="col-md-2 columns mt-3">
        <input id="end" type="text" class="form-control remarks" placeholder="Remarks" />
      </div>
      <div class="col-md-2 columns mt-3">
        <input id="min" type="text" class="form-control edatefrom" placeholder="EDate from" />
      </div>
      <div class="col-md-2 columns mt-3">
        <input id="max" type="text" class="form-control edateto" placeholder="EDate to" />
      </div>
      <div class="col-md-2 columns mt-3">
        <div class="btn-group">
      ...
      <!-- <div class="col-md-1 columns">
        <select id="end" class="form-control season">
    ...
    <div class="row mb-3">
      {{-- <div class="col-sm-6 col-md-3">
        <input type="text" class="form-control datepicker min" id="min" placeholder="From" />
      </div>
      <div class="col-sm-6 col-md-3">
        <input type="text" class="form-control datepicker max" id="max" placeholder="To" />
      </div> --}}
    </div>
    <div class="row">
                <!-- begin col-12 -->
...
$(document).ready(function() {
    ...
    $(document).on('keyup','.title,.volume_number,.item_number,.month,.season,#minYear,#maxYear,.isbn,.publisher,.place,.author,.article,.subject,.remarks',function(){
        table.ajax.reload();
    });
    //reset filter
