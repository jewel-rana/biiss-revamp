...
@section('content')
    ...
    <div class="row mb-3" id="customFilters">
      ...
      <div class="col-md-2 columns mb-3">
        <input id="end" type="text" class="form-control accession" placeholder="Date of Publication" />
      </div>
      <div class="col-md-2 columns mb-3">
        <input id="end" type="text" class="form-control volume" placeholder="VOL" />
      </div>
      <div class="col-md-1 columns mb-3">
        <input id="end" type="text" class="form-control number" placeholder="NUMBER" />
      </div>
      <div class="col-md-1 columns mb-3">
        <input type="text" id="end" class="form-control month" placeholder="Month">
      </div>
      <div class="col-md-1 columns mb-3">
...
$(document).ready(function() {
    var table = $('#example').DataTable( {
        ...
        "buttons": [
            ...
            },
            {
                ...
                messageTop: '<div style="font-size:13px;text-align:center">Print Report : Magazines</div>',
                exportOptions: {
                    columns: [ 1, 2, ':visible' ]
                },
                autoPrint: true,
    ...
    $(customFilter).find('.friq').change( function() {
    ...
    // Event listener to the two range filtering inputs to redraw on input
    $(document).on('keyup','.title,.accession,.volume,.number,.month,#minYear,#maxYear,.isbn,.publisher,.place,.author,.article,.subject,.remarks',function(){
        table.ajax.reload();
    });
    ...
    // $(customFilter).find('.edate').keyup( function() {
