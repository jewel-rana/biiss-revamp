...
@section('content')
    @if(\App\Helpers\CommonHelper::hasPermission(['dashboard-stats']))
        <!-- begin row -->
        <div class="row">
            <!-- begin col-3 -->
            ...
            <div class="col-lg-3 col-md-6">
                <div class="widget widget-stats bg-info">
                    ...
                    <div class="stats-link">
                        <a href="{{ url('dashboard/member') }}">View All <i
                                class="fa fa-arrow-alt-circle-right"></i></a>
                    </div>
                </div>
            </div>
    ...
    @if(\App\Helpers\CommonHelper::hasPermission(['dashboard-issue']))
        <!-- begin row -->
        <div class="row">
            <!-- begin col-8 -->
            <div class="col-lg-8">
            ...
            <div class="col-lg-4">
                ...
                <div class="panel panel-inverse" data-sortable-id="index-7">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Issue Statistics <span
                                class="badge badge-info">{{ $issues['total'] }}</span>
                        </h4>
                    </div>
                    <div class="panel-body">
    ...
    @if(\App\Helpers\CommonHelper::hasPermission(['dashboard-returns']))
        <div class="row">
            <div class="col-lg-12">
        ...
        @section('ownjs')
            ...
            <script
                src="{{ asset('backend/color-admin-v4.2/admin/assets/plugins/flot/jquery.flot.time.min.js') }}"></script>
            <script
                src="{{ asset('backend/color-admin-v4.2/admin/assets/plugins/flot/jquery.flot.resize.min.js') }}"></script>
            <script
                src="{{ asset('backend/color-admin-v4.2/admin/assets/plugins/flot/jquery.flot.pie.min.js') }}"></script>
            <script
