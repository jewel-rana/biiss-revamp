        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div>
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="<?php echo (! isset($_GET['tab']) || $_GET['tab'] == 'book') ? 'active' : ''; ?>"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Book</a></li>
                    <li role="presentation" class="<?php echo (isset($_GET['tab']) && $_GET['tab'] == 'journal') ? 'active' : ''; ?>"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Journal</a></li>
                    <li role="presentation" class="<?php echo (isset($_GET['tab']) && $_GET['tab'] == 'seminar') ? 'active' : ''; ?>"><a href="#seminar" aria-controls="seminar" role="tab" data-toggle="tab">Seminar</a></li>
                </ul>
