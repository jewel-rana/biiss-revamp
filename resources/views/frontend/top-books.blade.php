        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="new_book">
                ...
                <div class="row">
                   ...
                   @php
                      $bookPhoto = ( $book->item['cover_photo'] ) ? asset( $book->item['cover_photo'] ) : asset('/default/cover/' . strtolower( $book->type ) . '.jpg');
                   @endphp
                   <div class="col-md-3 mb-3">
                      <div class="flip-card">
                        <a href="{{ route('single.show', $book->book_id) }}">
